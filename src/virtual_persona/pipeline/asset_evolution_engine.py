        ...
        self.state_store.append_outfit_memory(
            {
                ...
                "outfit_summary": package.outfit.summary,
                "top": package.outfit.top,
                "bottom": package.outfit.bottom,
                "outerwear": package.outfit.outerwear,
                "shoes": package.outfit.shoes,
                "accessories": package.outfit.accessories,
                "fit": package.outfit.fit,
                "fabric": package.outfit.fabric,
                "condition": package.outfit.condition,
                "styling": package.outfit.styling,
                "place": package.outfit.place,
                "activity": package.outfit.activity,
                "time_of_day": package.outfit.time_of_day,
                "social_presence": package.outfit.social_presence,
                "energy": package.outfit.energy,
                "habit": package.outfit.habit,
                "style_intensity": package.outfit.style_intensity,
                "outfit_style": package.outfit.outfit_style,
                "enhance_attractiveness": package.outfit.enhance_attractiveness,
                "outfit_override_used": package.outfit.outfit_override_used,
                "style_profile": ", ".join(package.outfit.style_profile or []),
