...
def normalize_publishing_plan_payload(
    ...
    *,
    ...
    return {
        ...
        "behavior_state": _extract_value(row, "behavior_state"),
        "habit": _extract_value(row, "habit") or _extract_value(row, "habit_used"),
        "place_anchor": _extract_value(row, "place_anchor") or _extract_value(row, "familiar_place_anchor"),
        "objects": _extract_value(row, "objects") or _extract_value(row, "recurring_objects_in_scene"),
        "self_presentation": _extract_value(row, "self_presentation") or _extract_value(row, "self_presentation_mode"),
        ...
        "recurring_habit_summary": _extract_value(row, "recurring_habit_summary"),
        ...
        "familiar_place_family": _extract_value(row, "familiar_place_family"),
        "familiarity_score": row.get("familiarity_score"),
        "recurring_objects_in_scene": _extract_value(row, "recurring_objects_in_scene"),
        "object_presence_mode": _extract_value(row, "object_presence_mode"),
        ...
        "transition_context": _extract_value(row, "transition_context"),
        "caption_voice_mode": _extract_value(row, "caption_voice_mode"),
        "action_family": _extract_value(row, "action_family"),
        "emotional_tone_family": _extract_value(row, "emotional_tone_family"),
        "social_context_hint": _extract_value(row, "social_context_hint"),
        "social_presence_detail": _extract_value(row, "social_presence_detail"),
        "caption_voice_constraints": _extract_value(row, "caption_voice_constraints"),
