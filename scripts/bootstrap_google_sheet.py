...
SHEETS = {
    ...
    "content_moment_memory": ["date", "city", "day_type", "scene_moment", "scene_moment_type", "moment_signature", "visual_focus", "scene_source", "shot_archetype", "platform_intent", "publish_score", "publish_decision", "decision_reason"],
